...
def build_model(cfg: Dict, encoder_dir: Optional[str] = None,
                attention_implementation: str = "sdpa") -> DecisionModel:
    from transformers import AutoConfig, AutoModel

    if encoder_dir and os.path.exists(encoder_dir):
        ecfg = AutoConfig.from_pretrained(encoder_dir)
        enc = AutoModel.from_config(ecfg, attn_implementation=attention_implementation)
    else:
        enc = AutoModel.from_pretrained(cfg["encoder"], attn_implementation=attention_implementation)
